...
timber.cacheSelectors = function () {
  timber.cache = {
    ...
    $thumbImages: $('.slider-photo-thumbs').find('a.slider-photo-thumb'),
...
theme.Product = (function() {
  ...
  function Product(container) {
    ...
    this.settings = $.extend({}, defaults, {
      ...
      selectors: {
        ...
        $thumbImages: $('.slider-photo-thumbs-' + sectionId).find('a.slider-photo-thumb'),
      }
    });
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    addVariantInfo: function() {
      ...
      console.log($('#VariantJson-' + this.settings.sectionId, this.$container).html());
    ...
    productVariantCallback: function(variant) {
      ...
      if (variant) {
        ...
        if (variant.available) {
          ...
          this.settings.selectors.$addToCartText.html("Stock Épuisé");
        ...
        var customPriceFormat = ' <span aria-hidden="true">' + customPrice + ' <small>HT</small></span>';
        ...
        if ( variant.compare_at_price > variant.price ) {
          ...
          priceSaving = '' + ( (variant.compare_at_price - variant.price)*100/(variant.compare_at_price) ).toFixed(0) + '% de réduction';
          this.settings.selectors.$comparePrice.html("[$]".replace('[$]', priceSaving)).show();
        } else {
